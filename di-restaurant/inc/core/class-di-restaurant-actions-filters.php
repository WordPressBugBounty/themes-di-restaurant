...
class Di_Restaurant_Actions_Filter {
	...
	public function post_sidebar_file() {
		...
		if( is_active_sidebar( 'sidebar-1' ) ) {
			...
			$args = array(
				'before_widget' => '<div class="widget widgets_sidebar clearfix %s">', 
				'after_widget' => '</div>',
	...
	public function excerpt_more( $more ) {
		global $post;
		return '... <div class="readmore-section"><a class="readmore-btn" href="' . esc_url( get_permalink( $post->ID ) ) . '">' . esc_html__( 'Continue reading', 'di-restaurant' ) . ' <i class="fa fa-arrow-right"></i></a></div>';
